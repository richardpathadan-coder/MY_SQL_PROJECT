...
SQL (8) → appears in almost every role

Python (7) → nearly as essential as SQL

Tableau (6) → dominant BI/visualization tool

Excel (3) → still required, but no longer the main skill

Cloud & modern stack tools (Snowflake, Azure, Databricks) are emerging but consistent

Dev tools (Git, Jira, Bitbucket) show analysts working in engineering-style teams
[
  {
    "job_id": 552322,
